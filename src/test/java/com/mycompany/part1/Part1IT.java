...
public class Part1IT {
    ...
    public void testSearchTaskByName() {
        Part1.searchTaskByName("Create Login", taskNames, developers, taskStatuses);
    ...
    public void testDisplayDoneTasks() {
        Part1.displayDoneTasks(taskNames, developers, taskDurations, taskStatuses);
...
public void testDeleteTaskByName() {
    ...
    assertTrue(taskNames.contains(deleteName));

    // Call the deleteTaskByName method
    Part1.deleteTaskByName(deleteName, taskNames, developers, taskDurations, taskIDs, taskStatuses);

    // Verify the task was removed
    assertEquals(3, taskNames.size()); // Verify size reduction
    assertFalse(taskNames.contains(deleteName)); // Ensure task is removed
    ...
    public void testDisplayLongestTask() {
        Part1.displayLongestTask(developers, taskDurations);
...
public void testAllTasks() {
    ...
    Part1.allTasks(taskNames, developers, taskIDs, taskDurations, taskStatuses);
    ...
    public void testSearchTaskByDeveloper() {
        Part1.searchTaskByDeveloper("Samantha Paulson", taskNames, developers, taskStatuses);
        assertEquals("Samantha Paulson", developers.get(2));
        assertEquals("Done", taskStatuses.get(2));
    }
}